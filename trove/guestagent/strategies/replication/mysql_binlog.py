...
MASTER_CONFIG = "log_bin = /var/log/mysql/mysql-bin.log"
SLAVE_CONFIG = """
log_bin = /var/log/mysql/mysql-bin.log
relay_log = /var/log/mysql/mysql-relay-bin.log
"""

# The MySQL port is hard coded in the config.template, so just
# make a constant here and assume it doesn't change
MYSQL_PORT = 3306
